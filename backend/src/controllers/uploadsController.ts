...
// Direct upload endpoint - temporarily disabled, use multipart upload instead
export const uploadDirect = async (req: Request, res: Response) => {
  res.status(501).json({
    success: false,
    error: 'Direct upload temporarily unavailable. Please use the standard upload method.',
  });
};
